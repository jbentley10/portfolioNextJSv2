...
describe('components', () => {
  describe('Error500', () => {
    it('should mount with props', function () {
      const wrap = mount(<Error500>Hello World</Error500>)
    ...
    it('should render as type and with content', function () {
      const wrap = render(<Error500>Hello World</Error500>)

      expect(wrap[0].type).toEqual('tag')
      expect(wrap[0].name).toEqual('div')
      // contain styles
      expect(wrap[0].attribs.class).toContain('error500')
