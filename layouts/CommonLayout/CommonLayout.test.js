...
describe('components', () => {
  describe('CommonLayout', () => {
    it('should mount with props', function () {
      const wrap = mount(<CommonLayout>Hello World</CommonLayout>)
    ...
    it('should render as type and with content', function () {
      const wrap = render(<CommonLayout>Hello World</CommonLayout>)

      expect(wrap[0].type).toEqual('tag')
      expect(wrap[0].name).toEqual('div')
      // contain styles
      expect(wrap[0].attribs.class).toContain('common-layout')
