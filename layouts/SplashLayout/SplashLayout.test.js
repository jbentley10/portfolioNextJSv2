...
describe('components', () => {
  describe('SplashLayout', () => {
    it('should mount with props', function () {
      const wrap = mount(<SplashLayout>Hello World</SplashLayout>)
    ...
    it('should render as type and with content', function () {
      const wrap = render(<SplashLayout>Hello World</SplashLayout>)

      expect(wrap[0].type).toEqual('tag')
      expect(wrap[0].name).toEqual('div')
      // contain styles
      expect(wrap[0].attribs.class).toContain('splash-layout')
